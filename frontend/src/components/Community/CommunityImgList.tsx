        ...
        <Box sx={modalStyle}>
          <Wrapper>
            <div className="leftDetailBox">
              <img src="http://img3.tmon.kr/cdn3/deals/2020/02/17/456660414/original_456660414_front_bda8d_1581922255production.jpg" alt="" />
            </div>
            <div className="rightDetailBox" style={{display:"flex",flexDirection:"column"}}>
              <div className="rightDetailBoxTop">
                <img src={detailInfo.image} alt="" width="32" height="32" />
                <div style={{marginLeft:"14px"}}>{detailInfo.userName}</div>
              </div>
                      ...
                      <div className="replysInfo">
                        ...
                        <div>
                          ...
                          <div style={{margin:"10px 0 0 14px"}}>
                            <span>6시간</span><span style={{marginLeft:"15px"}} onClick={() => tagUser(e.userName)}>답글 달기</span>
                          </div>
                          <div style={{display:"flex",margin:"10px 0 10px 14px"}}>
                            <div style={{borderBottom:"2px solid #e3e3e3",width:"40px",height:"13px"}}></div>
                            <span style={{marginLeft:"15px"}} onClick={() => toggle(e.userName)}>답글 보기</span>
                          </div>
                      { open === e.userName ? 
                            ...
                            {e.replyReply.map((ele:any) => {
                              return (
                                <div style={{display:"flex",margin:"20px 0"}}>
                                  <div style={{borderRadius: "70%"}}>
                                    <img src={ele.image} alt="" width="32" height="32"/>
                                  </div>
                                  <div style={{marginLeft:"14px"}}>
                                    {ele.userName}
                                  </div>
              ...
              <div style={{position:"absolute",width:"100%",bottom:"0px",borderTop:"1px solid #e3e3e3",height : "50px",paddingRight:"16px",paddingLeft:"16px" }}>
...
const detailInfo = {
  ...
  userName : "username1",
  detailContent : "아 이게 내 게시물입니다. 하고싶은말 쓸거에용 아 이게 내 게시물입니다. 하고싶은말 쓸거에용 아 이게 내 게시물입니다. 하고싶은말 쓸거에용 아 이게 내 게시물입니다. 하고싶은말 쓸거에용"
}
const replyData = [
  {
    image : "http://spnimage.edaily.co.kr/images/photo/files/NP/S/2021/06/PS21060900004.jpg",
    userName : "user2",
    replyContent : "저도 정말 가고싶어요 ㅇㅈ? 근데 긴 댓글이 필요해서 조금 말을 늘려볼게요. 아오 너무 귀찮아요 처음부터 잘 짜고 싶어요",
    replyReply : [
      {
        image : "https://img.vogue.co.kr/vogue/2021/12/style_61adc5db872b5.jpeg",
        userName : "user123",
