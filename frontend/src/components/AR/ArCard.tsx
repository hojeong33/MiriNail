  ...
  return (
    ...
    >
      ...
      <div
        ...
        onClick={() => window.open('https://3.38.183.211:8000/nail/client', 'AR 피팅 서비스', 'width=660, height=520, status=no, menubar=no, toolbar=no, resizable=no, directories=no, scrollbars=0, location=no')}
      >
