package com.nail.backend.domain.oauth.handler;
...
import com.nail.backend.domain.user.db.entity.UserRefreshToken;
...
import static com.nail.backend.domain.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
import static com.nail.backend.domain.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REFRESH_TOKEN;
