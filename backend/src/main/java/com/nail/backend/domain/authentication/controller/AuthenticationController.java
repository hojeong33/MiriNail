...
public class AuthenticationController {
    ...
    public ResponseEntity<BaseResponseBody> artistRegister(@ModelAttribute ArtistRegisterPostReq artistRegisterPostReq,
        ...
        System.out.println(registrationFile);
        DesignerApplication designerApplication = authenticationService.artistRegister(artistRegisterPostReq,registrationFile);
