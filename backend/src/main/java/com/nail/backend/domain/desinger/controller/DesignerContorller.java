package com.nail.backend.domain.desinger.controller;
...
import com.nail.backend.domain.desinger.request.DesignerNewsRegisterPostReq;
import com.nail.backend.domain.desinger.service.DesignerNewsService;
import com.nail.backend.domain.desinger.db.entitiy.DesignerNews;
...
public class DesignerContorller {
    ...
    public ResponseEntity<BaseResponseBody> designerNewsRemove (@PathVariable long designerNewsSeq){
        if(designerNewsService.desingerNewsRemove(designerNewsSeq)) {
