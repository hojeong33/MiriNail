...
//        Long userId = Long.valueOf(principal.getName());
         ...
         */
        Favorite favorite = favoriteService.favoriteRegister(principal.getName(), productId);
    ...
    public boolean getFavoriteUserUse ( Principal principal,
        ...
        if( favoriteService.getFavoriteUserUse(principal.getName(), productId)){
            return true;
        }else{
            return false;
        }
...
//        Long userId = Long.valueOf(principal.getName());
        Favorite favorite = favoriteService.favoriteRemove(principal.getName(), productId);
